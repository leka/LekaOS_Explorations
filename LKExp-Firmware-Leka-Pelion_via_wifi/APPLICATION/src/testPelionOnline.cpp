...
const uint8_t MBED_CLOUD_DEV_ENTROPY[] = {0xf6, 0xd6, 0xc0, 0x09, 0x9e, 0x6e, 0xf2, 0x37, 0xdc, 0x29, 0x88, 0xf1,
...
void client_error(int err)
{
	...
	if (err == MbedCloudClient::ConnectNetworkError || err == MbedCloudClient::ConnectDnsResolvingFailed ||
...
int pelionOnlineExample(void)
{
	...
	m2m_get_res = M2MInterfaceFactory::create_resource(m2m_obj_list, 3200, 0, 5501, M2MResourceInstance::INTEGER,
	...
	m2m_put_res = M2MInterfaceFactory::create_resource(m2m_obj_list, 3201, 0, 5853, M2MResourceInstance::INTEGER,
													   M2MBase::GET_PUT_ALLOWED);
	...
	m2m_post_res = M2MInterfaceFactory::create_resource(m2m_obj_list, 3201, 0, 5850, M2MResourceInstance::INTEGER,
	...
	m2m_deregister_res = M2MInterfaceFactory::create_resource(m2m_obj_list, 5000, 0, 1, M2MResourceInstance::INTEGER,
															  M2MBase::POST_ALLOWED);
	...
	if (m2m_factory_reset_res) { m2m_factory_reset_res->set_execute_function(factory_reset); }
